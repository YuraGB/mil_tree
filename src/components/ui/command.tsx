...
/**
 * Renders a dialog-backed command palette with a hidden header and an embedded Command container.
 *
 * @param title - Dialog header title (default: "Command Palette")
 * @param description - Dialog header description (default: "Search for a command to run...")
 * @param children - Elements rendered inside the embedded Command (input, list, groups, items, etc.)
 * @param className - Additional CSS classes applied to the DialogContent that wraps the Command
 * @param showCloseButton - Whether the DialogContent displays a close button (default: true)
 * @returns The Dialog element containing the Command palette
 */
...
/**
 * Render a centered empty-state placeholder for the command palette list.
 *
 * @returns The React element for the command list empty-state placeholder.
 */
...
/**
 * Styled wrapper for cmdk Command.Group that applies consistent heading and container styles.
 *
 * Renders a CommandPrimitive.Group with a `data-slot="command-group"` attribute and merges any
 * provided `className` with the component's default layout and heading styles.
 *
